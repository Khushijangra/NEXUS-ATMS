...
def phase_3(model):
    ...
    from intelligence.orchestration.hybrid_state import HybridStateBuilder
    from intelligence.orchestration.rl_controller import RLObservationMapper
...
def phase_5(model):
    ...
    try:
        ...
        # Manual Mapper since intelligence.orchestration.rl_controller threw ImportError earlier
        obs = np.zeros(28, dtype=np.float32)
        obs[0:4] = j.local_queues
        obs[4] = j.anomaly_severity
        obs[5:9] = j.local_wait_times
